...
const MilestoneAdd = (props) => {
    ...
    const {createMilestone,getUseList} = moduleStore;
    ...
    const onFinish = (values) => {
        const data = {
            ...
            moduleTime: dayjs(values.publishDate).format("YYYY-MM-DD"),
                    ...
                    arrow={
                        form.getFieldValue('moduleTime') ? (
                            <CloseCircleFill
                                ...
                                onClick={e => {
                                    e.stopPropagation()
                                    form.setFieldsValue({ moduleTime: null })
                                }}
                            />
                        ) : (
                            true
...
export default withRouter(inject("moduleStore")(observer(MilestoneAdd)));