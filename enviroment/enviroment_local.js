...
const plugin_base_url = JSON.stringify("http://192.168.10.26:3000");
...
const upload_url = JSON.stringify('http://192.168.10.26:8080')
...
const mobile_url = JSON.stringify('http://192.168.10.26:3010/')
const homes_url = JSON.stringify("http://192.168.10.26")
