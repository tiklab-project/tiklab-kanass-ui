...
const ViewInsight = (props) => {
     ...
     */
    const goEditInsight = () => {
        props.history.push(`/index/home/newInsight/${props.match.params.id}`)
    }
            ...
            {/* <Row className="view-insight-row">
                <Col sm={24} md={24} lg={{ span: 24 }} xl={{ span: "18", offset: "3" }} xxl={{ span: "18", offset: "3" }}> */}
                    <div className="view-insight">
                        <Breadcumb firstText="仪表盘" firstUrl="/index/home/insightlist" secondText={insightDetail && insightDetail.insightName}>
