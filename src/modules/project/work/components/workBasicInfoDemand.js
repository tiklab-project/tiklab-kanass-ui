...
import { Form, Input, Upload, message, Table, DatePicker, InputNumber, Select, Row, Col, Card } from "antd";
...
const WorkBasicInfo = (props) => {
    ...
    const { workId, workIndex, workTypeList, findWorkAttachList, createWorkAttach, attachList,
        updateWorkItem, formList, moduleList, sprintList, priorityList, editWork, userList, setEditorContent } = workStore;
    ...
    useEffect(() => {
        if(editorType){
            setEditor.current.changeEditor(priorityDes)
        }
    },[editorType])
            ...
            <Col lg={20} xl={18}>
                <div className="work-detail-tab-info">
                    ...
                    <div className="work-detail-box">
                        <div className="other-title">描述：</div>
                        {
                            editorType ?  <Editor setEditorContent={setEditorContent} ref={setEditor} />
                            :<div
                                className="priorityDes"
                                dangerouslySetInnerHTML={{
                                    __html: priorityDes,
                    ...
                    <div className="work-detail-box">
                        ...
                        <WorkRelation type="子需求" {...props} />
                    </div>
                    <div className="work-detail-box">
                        <div className="other-title">
                            子需求:
                        </div>
                        <WorkChild type="子需求" {...props} />
                    </div>
