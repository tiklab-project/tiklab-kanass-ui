...
import {
    Form, Input, Upload, message, Table, DatePicker, InputNumber, Select, Row, Col
} from "antd";
...
const WorkBasicInfo = (props) => {
    ...
    const updateSingle = (changedValues, allValues) => {
        console.log(Object.keys(changedValues), changedValues)
                    ...
                    <div className="detail-top">
                        <div className="left">
                            <Form
                                ...
                                labelAlign="left"
                            >
                                <Form.Item label="事项类型nomal" name="workType">
                                    <Select
                                        placeholder="请选择事项类型"
                                        allowClear
                            ...
                            >
                                ...
                                <Form.Item name="planTakeupTime" label="计划用时">
                                    ...
                                    <InputNumber
                                        ...
                                        showArrow={fieldName === "planTakeupTime" ? true : false}
