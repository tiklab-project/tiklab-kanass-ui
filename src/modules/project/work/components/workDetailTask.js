...
import WorkBasicInfo from "./workBasicInfoTask";
...
const WorkDetailDefect = (props) => {
    ...
    const deleteWork = () => {
        detWork(workId).then(() => {
            ...
            } else if (workShowType === "listTree" || workShowType === "tableTree") {
            ...
            } else if (workShowType === "listTile" || workShowType === "tableTile") {
        ...
        <div className="work-detail">
            ...
            <div className="work-detail-tab">
                <Tabs activeKey={activeKey} type="card" size="small" onTabClick={(event) => onTabClick(event)}>
                    ...
                    <TabPane tab="关联任务" key="relation">
                        <WorkRelation type="任务" {...props} />
                    </TabPane>

                    <TabPane tab="子任务" key="child">
                        <WorkChild workId={workId} workType={workInfo.workType.id} type="任务" {...props} />
                    </TabPane>
