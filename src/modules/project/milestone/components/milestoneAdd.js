...
const MilestoneAddmodal = (props) => {
    ...
    return (
        <div className="addmodel">
            {   
                props.type !== "edit"?
                <PrivilegeProjectButton code={'MilestoneAdd'} disabled ={"hidden"} domainId={projectId}>
                    <Button type="primary" onClick={showModal}>
                        +{props.name}
                    </Button>
                </PrivilegeProjectButton>: 
                <PrivilegeProjectButton code={'MilestoneEdit'} disabled ={"hidden"} domainId={projectId}>
            ...
            >
                ...
                >
                    ...
                    <Form.Item name="milestoneTime" label="计划日期">
                        <DatePicker />
                    </Form.Item>
                </Form>
            </Modal>
...
export default inject("milestoneStore")(observer(MilestoneAddmodal));