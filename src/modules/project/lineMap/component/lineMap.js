    ...
    return (
        <>
            <div className="linemap-time">
                <div style={{ position: "relative", display: "flex", maxHeight: "80vh" }}>
                    <div className="time-table">
                        ...
                        <div className="table-body " id="tale-body">
                            <div>
                                ...
                                <div className="table-pic" id="table-pic" ref={ganttOuter}>
                                    <div id="tableGantt" ref={ganttCore} style={{ width: ganttWidth, height: data.length * 50 }} className="gantt-box" />
                                </div>
                            </div>
                        </div>
                    </div>
