...
export class StatisticStore {
    ...
    @observable reportList = [
        ...
        },
        {
            title: '事项创建与解决统计',
            icon: 'iconsmile',
            type: 'statisticBulidWork',
            key: `/index/prodetail/statistics/workbulidend`,
            children: []
        }
    ]
    // @action
    ...
    statisticWorkItem = async(value) => {
        const params = new FormData();
        params.append("field", value.field)
        const data = await StatisticWorkItem(params);
        return data;
    }
    ...
    statisticBuildAndEndWorkItem = async(value) => {
        ...
        const data = await StatisticBuildAndEndWorkItem(params);
        return data;
    }
