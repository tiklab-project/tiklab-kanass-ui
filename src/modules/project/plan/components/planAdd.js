...
const  PlanAddmodal = (props) => {
    ...
    const {planStore,proStore} = props;
    ...
    return (
        ...
        <div className="addmodel">
            {props.type === "add"?
                ...
                :
                <span onClick={showModal} style={{color: "$blue-main"}} type="link">
                    {props.name}
                </span>
...
export default inject("proStore","planStore")(observer(PlanAddmodal));