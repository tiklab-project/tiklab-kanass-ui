...
import {
    ...
    FindProjectTypeListById, DeleteProjectTypeList, FindIconList,
    GreatIcon
} from "../api/proType";
...
export class ProjectTypeStore {
    ...
    @action
    addProjectTypeList = (value) => {
        AddProjectTypeList(value).then(response => {
            // this.projectTypelist = response.data;
            if (response.code === 0) {
    ...
    deleteProjectTypeList = (id) => {
        ...
        DeleteProjectTypeList(params).then(response => {
