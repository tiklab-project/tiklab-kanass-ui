...
const ProjectStaticsEndTrend = (props) => {
    const { statisticsStore } = props;
    const { findReport, statisticsEndWorkItemCount, findProjectList } = statisticsStore;
    ...
    return (
        <div className="statistics-work">
            <div className="statistics-work-top">
                <div className="first-level">事项完成趋势</div>
                <Form
                    name="form"
                    form={form}
                ...
                >
                    ...
                    {/* <div className="statics-submit">
                        ...
                        <PrivilegeProjectButton code={'ReportAdd'} disabled={"hidden"} domainId={projectId}  {...props}>
                            <Button type="primary" htmlType="submit" onClick={() => onFinishFailed()}>
                                保存报表
                            </Button>
            ...
            <div className="statistics-work-content">
                ...
                <div id="workBar" style={{ height: "500px", marginTop: "20px", width: "100%" }} />
...
export default withRouter(inject('statisticsStore')(observer(ProjectStaticsEndTrend)));