...
//每日新增
export function StatisticsWorkItemTotalCountList(data){
    return service.request({
        url: "/projectInsightReportController/statisticsWorkItemTotalCountList",
        method: "post",
        data
    })
}
...
//每日完成
export function StatisticsEndWorkItemTotalCountList(data){
    return service.request({
        url: "/projectInsightReportController/statisticsEndWorkItemTotalCountList",
        method: "post",
        data
    })
}
