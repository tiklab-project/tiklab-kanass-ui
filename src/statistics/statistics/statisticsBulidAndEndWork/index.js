...
import "../components/WorkStatistics.scss"
const StatisticsBulidAndEndWork = (props) => {
    const { statisticBuildAndEndWorkItem, findProjectList } = statisticStore;
    ...
    return (
        <div className="statistics-work">
            <div className="statistics-work-top">
                <div className="statistics-work-title">事项创建与解决统计sss</div>
                <Form
                    name="form"
                    form={form}
...
export default withRouter(StatisticsBulidAndEndWork);