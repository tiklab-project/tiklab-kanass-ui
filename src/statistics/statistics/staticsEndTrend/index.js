...
const StaticsEndTrend = (props) => {
    const { statisticsEndWorkItemCount, findProjectList } = statisticStore;
    ...
    return (
        <div className="statistics-work">
            <div className="statistics-work-top">
                <div className="statistics-work-title">事项完成趋势</div>
                <Form
                    name="form"
                    form={form}
...
export default withRouter(StaticsEndTrend);