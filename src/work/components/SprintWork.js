...
import SprintWorkTable from "./SprintWorkTable";
...
import SprintWorkBreadCrumb from "./SprintWorkBreadCrumb";
import WorkTableFilter from "./WorkTableFilter";
import { Col, Form, Row } from "antd";
import { getUser } from "tiklab-core-ui";

const SprintWork = (props) => {
    ...
    useEffect(() => {
        ...
        if (props.match.path === "/index/:id/sprintdetail/:sprint/workItem/:statetype") {
            goSprintWorkItem()
        }
    ...
    return (
        <Fragment>
            ...
            {
                workShowType === "table" &&
                <SprintWorkTable {...props} form={form}></SprintWorkTable>
            ...
            }
            {
                ...
                <Fragment>
                    <Row style={{height: "100%", backgroundColor: "#fff"}}>
                        <Col className="work-col" style={{height: "100%"}} lg={{ span: 24 }} xxl={{ span: "18", offset: "3" }}>
                            <SprintWorkBreadCrumb />
            ...
            {
                // workShowType === "time" && <WorkGantt />
                workShowType === "time" && <Fragment>
                    <Row style={{height: "100%", backgroundColor: "#fff"}}>
...
export default inject("workStore", "workCalendarStore")(observer(SprintWork));