...
import ProjectSetContent from "../components/ProjectSetTable"
import ProjectSetGide from "../components/ProjectSetGide"
    ...
    return (
        <div className="projectSet">
            <Layout className="projectSet-content">
                {allProjectSetList && allProjectSetList.length > 0 ? <ProjectSetContent />
                    :
                    <ProjectSetGide />
                }
            </Layout>
