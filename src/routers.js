...
const QywxInstall = AsyncComponent(() => import('./modules/qiyeWeixin/components/qywxInstall.js'))
...
const ProgramList = AsyncComponent(() => import('./modules/program/components/programContent'))
    ...
    },
    {
        ...
        routes: [
            ...
            },
            {
                ...
                routes: [
                    {
                        path: "/index/program/programList",
                        exact: false,
                        component: ProgramList,
                        key: "Program"
                    },
                    {
                        path: "/index/program/programDetail/:id",
                        exact: false,
            ...
            },
            {
                ...
                routes: [
                    ...
                    {
                        path: "/index/prodetail/scrum/:type",
                        component: Work
                    },
                    // {
                    //     path: "/index/prodetail/task",
                    //     component: Work
                    // },
                    // {
                    //     path: "/index/prodetail/work",
