        ...
        <>
            <div className="log-tab-filter">
                <div className="log-view-tabs">
                    <div
                        className={`log-view-tab ${activeTab === "allLog" ? "active-tabs" : ""}`}
                        key={"allLog"}
                    ...
                    <div
                        className={`log-view-tab ${activeTab === "myLog" ? "active-tabs" : ""}`}
                        key={"myLog"}
                ...
                <div className="log-tab-filter-right">
...
export default withRouter(inject("logStore")(observer(LogViewTable)));